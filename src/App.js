...
const TrackerData = {
  ...
  AccountOptions: [
    ...
    { key: 'o', text: 'HomeLoan', value: 'HomeLoan' },
    { key: 'c', text: 'Cash', value: 'Cash' },
    { key: 's', text: 'SureshAC', value: 'SureshAC' },
    { key: 'by', text: 'ByjuAC', value: 'ByjuAC' },
    { key: 'sa', text: 'SahajanAC', value: 'SahajanAC' },
    { key: 'ma', text: 'MathaAgencies', value: 'MathaAgencies' },
    { key: 'k', text: 'KaricalElectric', value: 'KaricalElectric' },
    { key: 'b', text: 'BineeshWood', value: 'BineeshWood' },
    { key: 'kai', text: 'KaitharamTile', value: 'KaitharamTile' },
    { key: 'sat', text: 'SathyanTile', value: 'SathyanTile' },
    { key: 'ot', text: 'OtherTileAC', value: 'OtherTileAC' },
    { key: 'man', text: 'ManojSteel', value: 'ManojSteel' },
    { key: 'p', text: 'PaintLabour', value: 'PaintLabour' },
    { key: 'fl', text: 'FloorTile', value: 'FLoorTile' },
    { key: 'd', text: 'DonateCash', value: 'DonateCash' },
    { key: 'v', text: 'VishnuFabtree', value: 'VishnuFabtree' },
  ],
  toggleIncome: true,
  loaderFlag: false,
  showLoginPage: true,
